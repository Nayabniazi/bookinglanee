...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1 style={{color:'black'}}>Airport transfers with Bookinglane</h1>
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Experience unmatched flexibility with our airport transportation.</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>We are pleased to help you create a timetable that perfectly suits your needs. We value your time and provide fast, efficient service. Expect to arrive at the airport on schedule.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/pic4.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/pic1.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Never before have airport transfers been so easy nationwide.
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">We make airport transfers easy, removing one worry. Our elite vehicle fleet ensures you arrive on time with extra luxury. Whether you are prompt or daring, our skilled airport chauffeurs service ensure top-notch service. Expect a smooth and enjoyable ride from your first pick-up point to the airport or to your destination. We love making airport transfers go well and offering our customers a fantastic experience.</p>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'30px'}}>Your Reliable Domestic Airport Transfer Partner</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginBottom:'0px',marginRight:'100px'}}>All around the US Bookinglane is the leading provider for US airport transfers, serving all of your domestic travel needs. Rest certain that your journey will be elegant and stylish. Our exceptional chauffeur service and executive limousines assure a smooth journey.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/pic2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/pic3.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'200px',marginLeft:'150px'}}>Skilled chauffeurs prioritize both safety and style.
                                </h4>
                               
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn "style={{marginBottom:'0px',marginRight:'150px',marginLeft:'150px'}}>Our friendly chauffeurs focus on ensuring your safety, comfort, and punctuality. Our wide selection of luxury cars and limousines will ensure your airport arrival is truly memorable.</p>
