...
const HistoryPage = () => {
 ...
 const [activeTab, setActiveTab] = useState("one-way");
  ...
  const airports = [
    ...
    { name: "Long Beach  Airport", code:'CA', link: "/sanjosepage" },
...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Airport transfers with Travelingoo</h1>
...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/airport.webp'); /* Background image */
        ...
        <div className="line"></div>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Never before have airport transfers been so easy nationwide.</h2>
                            ...
                            <div className="col-lg-6"><img className="wow animate__animated animate__fadeIn" src="/img/pic1.png" alt="transp" /></div>
                        </div>
                        <div className="row align-items-center item-about-2">
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/pic2.png" alt="transp" /></div>
                            <div className="col-lg-6">
                                <div className="box-info-about-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Your Reliable Domestic Airport Transfer Partner</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">All around the US Bookinglane is the leading provider for US airport transfers, serving all of your domestic travel needs. Rest certain that your journey will be elegant and stylish. Our exceptional chauffeur service and executive limousines assure a smooth journey.
           </p>
                               </div>
                            </div>
                        </div>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Skilled chauffeurs prioritize both safety and style.</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">Our friendly chauffeurs focus on ensuring your safety, comfort, and punctuality. Our wide selection of luxury cars and limousines will ensure your airport arrival is truly memorable.
</p>
                                   
                                </div>
                            </div>
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/pic3.png" alt="transp" /></div>
                        </div>
                        <div className="row align-items-center item-about-2">
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/pic4.png" alt="transp" /></div>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Experience unmatched flexibility with our airport transportation.</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn"> We are pleased to help you create a timetable that perfectly suits your needs. We value your time and provide fast, efficient service. Expect to arrive at the airport on schedule.
                                    </p>
                               </div>
                            </div>
                        </div>
