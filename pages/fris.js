...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Experienced Chauffeur Service in Car service in Fairfax, VA</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Upgrade your travel experience with our professional car service in Car service in Fairfax, VA Whether you’re heading to a meeting, exploring the city, or catching a flight, our service ensures a seamless journey in style and comfort. Relax and let us handle the logistics while you focus on what matters most .</p>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>The Premium Car Service Right Here in Car service in Fairfax, VA
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">Bookinglane, your first-rate black car service friend, will help you to really explore Car service in Fairfax, VA Our dedication is to make your trip around the city unforgettable as much as the sites themselves are. Our service is customized to your schedule and travel tastes whether your desired visit is for the architectural marvels, calm parks, or busy marketplaces. Discover Albuquerque, NM with comfort, elegance, and local flare Bookinglane can provide</p>
