...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(206, 130, 37);
    }
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
      ...
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          There is never more easy planning your transportation. Showing a refined reserve system, we provide Limo service in East Bay, TX first-rate chauffeur services. Our simple-to-use system ensures a perfect and safe experience with fast booking and a selection of car alternatives. Whether for hourly rates or one-way journeys, we guaranteed by arriving on-time and dependable chauffeur service throughout all states in the USA. With Bookinglane you can get stress-free Dallas, TX Chauffeur service with seasoned chauffeurs providing safety and timeliness top priority.
          </p>
        </div>
        <div className="line"></div>
      </div>
...
<style jsx>
  {`
    ...
    .search-btn:hover {
      background: rgb(207, 140, 33); /* Darker shade on hover */
    }
