...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Top destinations with Travelingoo</h1>
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(205, 123, 34);
    }
...
<div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Discover Unmatched Luxury with Bookinglane in Top US Destinations</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                 
                                    Embark on a journey of luxury and convenience with Bookinglane's top destinations across the United States. Our premium car service caters to travelers seeking a seamless and stylish experience in cities renowned for their charm and vibrancy.
                        ...
                        <div className="row align-items-center item-about-2">
                            ...
                            <div className="col-lg-6">
                                <div className="box-info-about-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Corporate Travel Solutions:</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    For business travelers, Bookinglane offers corporate travel services that reflect the professionalism of your brand. Impress clients and empower your team with our dedicated and sophisticated transportation solutions.
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Seamless Airport Transfers:</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">Make airport transfers stress-free with Bookinglane. Our chauffeurs ensure timely arrivals and departures, providing a hassle-free start or end to your journey.
</p>
