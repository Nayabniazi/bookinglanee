...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    Book Executive Car & Chauffeur Service for Innercity and Intercity Rides
    </h1>
...
.heroo {
  ...
  background-image: url('/img/road.png'); /* Add your image path here */
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Why choose Bookinglane?</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Have you ever been in need of executive car or limousine service to travel within or between cities? With the executive level of chauffeur service provided by our transportation solution, your instant solution has arrived! We offer a professional and discrete way to get you where you need to be quickly and comfortably. Enjoy a carefree ride without having to worry about traffic, parking and figuring out directions - whether for business meetings or for private trips. Rest assured that with us, your comfort is our priority.</p>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/road2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
