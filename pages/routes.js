...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Top routes with Travelingoo</h1>
...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/road2.png'); /* Background image */
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(209, 117, 42);
    }
...
<div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">
                                    Seamless Journeys Between Cities: Experience Excellence with Bookinglane
                                    </h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    Discover the convenience of traveling between key destinations with Bookinglane's curated list of top routes. Whether you're planning a business trip, a weekend getaway, or a leisurely tour, our premium car service ensures a smooth and enjoyable journey between cities. Explore the advantages of choosing Bookinglane for your inter-city travel: 
                                  </p>
                                    
                                </div>
                            </div>
                            <div className="col-lg-6"><img className="wow animate__animated animate__fadeIn" src="/img/road.png" alt="transp" /></div>
                        </div>
                        <div className="row align-items-center item-about-2">
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/road2.png" alt="transp" /></div>
                            <div className="col-lg-6">
                                <div className="box-info-about-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Customized Stops Along the Way:</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    Make the journey yours by adding personalized stops along the route. Whether it's a scenic spot, a business meeting, or a quick detour, Bookinglane adapts to your preferences.
           </p>
                               </div>
                            </div>
                        </div>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Luxury Fleet, Every Mile:</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">Travel in style and luxury with our premium fleet of well-maintained vehicles. Whether you choose a sedan, SUV, or another option from our impressive lineup, you'll arrive at each destination in comfort and sophistication.
</p>
                                   
                                </div>
                            </div>
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/road3.png" alt="transp" /></div>
                        </div>
