...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Top routes with Bookinglane</h1>
...
.hero {
  ...
  background-image: url('/img/carpic.png'); /* Add your image path here */
...
<section style={{ padding: "50px 20px", marginTop: '100px' }}>
    ...
    <h3 style={{marginLeft:'200px',marginBottom:'100px',marginTop:'80px'}}>Trusted by professionals at</h3>
...
<div className="row align-items-center"style={{marginLeft:'160px',marginTop:'200px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Seamless Journeys Between Cities: Experience Excellence with Bookinglane</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Discover the convenience of traveling between key destinations with Bookinglane's curated list of top routes. Whether you're planning a business trip, a weekend getaway, or a leisurely tour, our premium car service ensures a smooth and enjoyable journey between cities. Explore the advantages of choosing Bookinglane for your inter-city travel:.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/road.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/road2.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Effortless City-to-City Transfers:
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">.Bookinglane simplifies the process of moving between cities. Our top routes connect major urban centers, providing a seamless and efficient mode of transportation.</p>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Professional Chauffeurs for Every Leg:</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Throughout your journey, our experienced chauffeurs are dedicated to ensuring your safety and comfort. From departure to arrival, enjoy the expertise of drivers who know the routes intimately..</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/road3.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/carpic.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Expert Chauffeurs:
                                </h4>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Seamless Airport Transfers:</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>.Make airport transfers stress-free with Bookinglane. Our chauffeurs ensure timely arrivals and departures, providing a hassle-free start or end to your journey..</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/inte.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
