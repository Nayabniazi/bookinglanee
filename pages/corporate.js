...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/background.webp'); /* Background image */
        ...
        <div className="line"></div>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Private transportation solution</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                            ...
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/cop3.png" alt="transp" /></div>
                        </div>
