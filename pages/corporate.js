...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1 style={{marginRight:'200px'}}>Book Executive Car & Chauffeur
    Service for Corporate Travel</h1>
...
.heroo {
  ...
  background-image: url('/img/corporate.png'); /* Add your image path here */
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <p className=" paragraph font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn" >Traveling for business can be stressful and time-consuming, but with Bookinglane, you can make it a breeze. Our corporate travel service provides you with a convenient and reliable way to travel in style and comfort. Our limo service and professional chauffeur will ensure that you arrive at your destination safely, on time, and in a luxurious vehicle.</p>
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Safety</h2>
          <p className="paragraph font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Safety is always a top priority at Bookinglane. Our chauffeurs are background checked, and our vehicles are equipped with the latest safety features. You can rest assured that you will be in safe hands with us.
           </p>
        </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Reliability is at the core of what we do at Bookinglane. Our leading automated technology ensures that you can book your travel quickly and easily. Our chauffeurs are always on time, and our vehicles are well-maintained, so you can be sure that your travel plans will go off without a hitch.
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Comfort</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Comfort is also a crucial factor in corporate travel. That's the reason why we offer luxury sedans, limos and SUVs, equipped with the latest technology and amenities. Whether you are traveling to a business meeting or a conference, you can travel in comfort with a professional chauffeur.
          </p>
        </div>
        <div className="line"></div>
      </div>
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          We understand that privacy is essential for business travel. Thus, we guarantee complete privacy and confidentiality when you travel with us. You can conduct your business in peace, knowing that your information is safe and secure.
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Flexibility</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          By contacting our customer support, ou can make changes to your travel plans at any time. You can also customize your travel experience to meet your specific needs.
          </p>
        </div>
        <div className="line"></div>
      </div>
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Cost effectiveness</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Traveling for business doesn't have to be expensive. With Bookinglane, you can enjoy a cost-effective solution that offers luxury, comfort, and reliability at an affordable price.
Choosing Bookinglane for your corporate travel needs is a smart decision. With our convenient, professional, safe, reliable, private, and cost-effective services, you can travel with confidence, knowing that you are in good hands. Moreover, Bookinglane platform offers an instant booking of an executive car service with upfront pricing. It literally just takes a few clicks!
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Private jet transportation</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Bookinglane's executive car and chauffeur service provides transportation to and from a variety of private jet terminals, including JSX, Signature, and more. With a fleet of luxury vehicles and experienced drivers, Bookinglane ensures that business travelers arrive at their destination on time and with comfort.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/cop2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/cop3.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Private transportation solution
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">One of the many advantages of Bookinglane's executive car and chauffeur service is the opportunity for long-term relationships with businesses and their employees. This allows Bookinglane to get to know the unique needs and preferences of each traveler, which in turn leads to a more personalized and efficient travel experience.</p>
...
<section className="contact-us">
      ...
      <form className="contact-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <div className="phone-input-container"style={{height:'40px'}}>
            <select
              id="country"
              name="country"
