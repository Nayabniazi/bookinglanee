...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1 style={{marginLeft:'30px'}}>Discover the Ultimate Travel Experience With Our Chauffeur Service</h1>
...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/special.png'); /* Background image */
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(213, 126, 45);
    }
...
<div className="layout-container"style={{marginLeft:'130px',marginRight:'130px',marginTop:'100px'
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                    ...
                                    Our goal is to provide you with a stress-free and comfortable ride, no matter where your travels may take you. We understand that every client has unique needs and requirements, which is why we offer a fully customizable service to meet your specific needs. Whether you're traveling for business or for pleasure, we will work with you to create a travel itinerary that is tailored to your schedule and preferences. So why wait? Experience the ultimate in travel comfort and luxury with our chauffeur service. Book your ride today and let us take care of the rest. Contact us for more information about our limo service and chauffeur services and let us help you discover the ultimate travel experience. With Travelingoo, you can find and book an executive car service in the area in a matter of a few clicks.
</p>
                                   
                                </div>
                            </div>
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/drive1.png" alt="transp" /></div>
                        </div>
  ...
  <div className="row justify-content-center">
    <div className="col-lg-8 col-md-10 col-12">
      <h2 className="color-black text-center mb-4 wow animate__animated animate__fadeIn" style={{marginTop:'100px'}}>Contact Us</h2>
