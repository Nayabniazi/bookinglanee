...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    Discover the Ultimate Travel Experience With Our Chauffeur Service
    </h1>
...
.heroo {
  ...
  background-image: url('/img/special.png'); /* Add your image path here */
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Planning a special tour? Bookinglane is here for you.</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>When it comes to limousine tour services, you can’t go wrong with hiring a chauffeur. From the comfort of sophisticated limousines to the convenient transportation for any special event like wine tours and destination weddings, having a chauffeur at the wheel is an asset that many appreciate. Enjoying a limousine service with a professional chauffeur behind the wheel provides an experience unmatched by other forms of transportation. So next time you’re looking for limousine tours or chauffeur services, make sure your expectations are nothing short of extraordinary!</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/lady2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/special1.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">Discover the ultimate travel experience with our chauffeur service at Bookinglane. Our team of professional and experienced chauffeurs are dedicated to providing the highest quality transportation services to meet all of your needs. Whether you're looking for a luxurious limo service or a sophisticated chauffeur service, we have you covered. With a fleet of the latest and greatest limousines, we are proud to offer an unrivaled limo service that is unmatched in terms of comfort, style, and luxury. Our chauffeurs are knowledgeable, friendly, and always ready to ensure that you have a smooth and seamless ride. When you travel with us, you can sit back, relax, and enjoy the journey. Our chauffeur service provides you with a worry-free travel experience, freeing you up to focus on your work or simply enjoy the scenery.</p>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                ...
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Our goal is to provide you with a stress-free and comfortable ride, no matter where your travels may take you. We understand that every client has unique needs and requirements, which is why we offer a fully customizable service to meet your specific needs. Whether you're traveling for business or for pleasure, we will work with you to create a travel itinerary that is tailored to your schedule and preferences. So why wait? Experience the ultimate in travel comfort and luxury with our chauffeur service. Book your ride today and let us take care of the rest. Contact us for more information about our limo service and chauffeur services and let us help you discover the ultimate travel experience. With Bookinglane, you can find and book an executive car service in the area in a matter of a few clicks.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/special2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
