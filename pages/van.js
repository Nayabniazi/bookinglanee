...
`}
  ...
  <button className="cta-button"  style={{ marginTop: '20px', borderRadius: '20px' }}>
    ...
    <div className="row align-items-center"style={{marginLeft:'160px',marginTop:'200px'}}>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/carypic2.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
                       

                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img src="/img/carypic.png" alt="transp" style={{width:'500px',marginLeft:'160px'}}/></div></div>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Book your sprinter van transportation today!
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">.At Bookinglane, we’re redefining group travel with our Sprinter Vans. We are deeply committed to delivering the highest standards of service, safety and comfort.

Feel free to book your Sprinter Van using our online booking form to experience truly luxurious transportation. We are very excited to show you why so many choose Bookinglane for their premium transportation needs.

As we all know, it's all about enjoying your travel, so choose Bookinglane to do exactly that!</p>
