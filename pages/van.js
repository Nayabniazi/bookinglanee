...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Sprinter Van Transportation</h1>
...
<div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Ultimate comfort and convenience of sprinter van transportation</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    Our Sprinter vans offer plenty of room and excellent comfort for every passenger. Featuring spacious interiors, comfortable seating, and state-of-the-art climate control, you can unwind and experience a comfortable journey, regardless of the distance.  
                                  </p>
                                    
                                </div>
                            </div>
                            <div className="col-lg-6"><img className="wow animate__animated animate__fadeIn" src="/img/carypic.png" alt="transp" /></div>
                        </div>
                        ...
                        <div className="row align-items-center item-about-2">
                            <div className="col-lg-6"style={{marginTop:'100px'}}><img className="wow animate__animated animate__fadeIn" src="img/carypic2.png" alt="transp" /></div>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Why choose sprinter van transportation?
                                    </h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn"> 
                                      
                                      
                                      
                                    Travelingoo's Sprinter vans are made to improve group travel, providing roomy interiors ideal for corporate trips, family vacations, or airport transfers. The spacious luggage capacity makes sure that all personal items are easily stored, leading to effortless travels. Our vans turn group trips into pleasant and relaxing adventures, providing passengers with the opportunity to unwind and bond while traveling.
