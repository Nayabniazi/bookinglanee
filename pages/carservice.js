...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Bookinglane Black Car Service</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}>Bookinglane is a top choice for premium car service. They offer flexible rides and a warm welcome. They prioritize customer satisfaction and transparency, with clear fares and availability nationwide. Their free cancellation policy and 24/7 support add to their commitment to customer care. Additional flexibility and support are provided through free cancellation and 24/7 support. Bookinglane enhances the comfort and convenience of vehicle service experiences, resulting in unforgettable journeys..</p>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn" style={{marginRight:'140px',marginLeft:'80px'}}>Your professional car service
                                </h4>
                               
                                <p style={{marginRight:'140px',marginLeft:'80px'}} className="font-md color-grey-700 wow animate__animated animate__fadeIn">Bookinglane provides travelers who are in seeking of first-class car service with fleet ranges in comfort and design from business sedan to roomy SUVs and VANs. The platform's greet & meet service is notable for its ability to ensure that passengers have a stress-free arrival and departure at airports or hotels. Chauffeurs greet passengers upon their arrival. Priority is given to reliability, which is achieved through forthright fares and punctual arrivals, thereby preventing any unforeseen expenses.</p>
