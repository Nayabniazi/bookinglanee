...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Professional car services</h1>
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(211, 123, 34);
    }
        ...
        <div className="line"></div>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Travelingoo black car service</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    Travelingoo is a top choice for premium car service. They offer flexible rides and a warm welcome. They prioritize customer satisfaction and transparency, with clear fares and availability nationwide. Their free cancellation policy and 24/7 support add to their commitment to customer care. Additional flexibility and support are provided through free cancellation and 24/7 support. Bookinglane enhances the comfort and convenience of vehicle service experiences, resulting in unforgettable journeys.    
                                  </p>
                        ...
                        <div className="row align-items-center item-about-2">
                            ...
                            <div className="col-lg-6">
                                <div className="box-info-about-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Your professional car service</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">

                                    Travelingoo provides travelers who are in seeking of first-class car service with fleet ranges in comfort and design from business sedan to roomy SUVs and VANs. The platform's greet & meet service is notable for its ability to ensure that passengers have a stress-free arrival and departure at airports or hotels. Chauffeurs greet passengers upon their arrival. Priority is given to reliability, which is achieved through forthright fares and punctual arrivals, thereby preventing any unforeseen expenses.
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Travelingoo reliable car service</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">

                                    Travelingoo is a dependable vehicle service that provides a variety of transport options, such as hourly, one-way, and round-trip. Our pricing is transparent, ensuring that there are no hidden costs and allow more effective trip planning. Travelingoo black car service is accessible in all 50 states of the United States, ensuring that it is accessible from any location.
