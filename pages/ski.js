...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/sky.png'); /* Background image */
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(207, 128, 37);
    }
...
<div className="layout-container"style={{marginLeft:'130px',marginRight:'130px',marginTop:'100px'
     ...
     <div className="content-section">
        ...
        <div className="content-row">
          ...
          At Travelingoo, we’re redefining ski transportation with our luxury chauffeur services. We’re dedicated to delivering exceptional service, safety, and comfort for your journey to any ski resort in the USA.
          </p>
            </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          Use our easy-to-use online booking tool to plan your private ski ride. Travelingoo promises a perfect, stylish, and stress-free ride, no matter if you're traveling alone or with a group.
         </p>
     ...
     <div className="content-section">
        ...
        <div className="content-row">
          ...
          Most ski trips are just for enjoying the slopes; let us take care of the journey. Choose Travelingoo for the best in high-end ski service!
         </p>
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Luxury Ski Transfers Across the USA - Private & Comfortable Ski Transportation</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    Experience premium ski transportation with our luxury ski chauffeur service available at all ski resorts across the USA. Get an instant quote for solo or group travel and enjoy seamless private ski transfers designed for comfort and convenience.
                                 
                                             </p>
                                    
                                </div>
                            </div>
                            <div className="col-lg-6"><img className="wow animate__animated animate__fadeIn" src="/img/ski.png" alt="transp" /></div>
                        </div>
