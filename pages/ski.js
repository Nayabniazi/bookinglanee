...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1 style={{color:'white',marginRight:'60px',marginLeft:'200px'}}>Luxury Ski Transfers & Private Ski
    Transportation Across the USA</h1>
...
.hero {
  ...
  background-image: url('/img/sky.png'); /* Add your image path here */
...
<h3>Book Your Luxury Ski Transfer Today!</h3>
      {/* Section 3 */}
...
1
          ...
          At Bookinglane, we’re redefining ski transportation with our luxury chauffeur services. We’re dedicated to delivering exceptional service, safety, and comfort for your journey to any ski resort in the USA.  </p>
        </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          Use our easy-to-use online booking tool to plan your private ski ride. Bookinglane promises a perfect, stylish, and stress-free ride, no matter if you're traveling alone or with a group.
        </p>
         </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        ...
        <div className="content-row">
          ...
          Most ski trips are just for enjoying the slopes; let us take care of the journey. Choose Bookinglane for the best in high-end ski service!
    ...
    <div className="row align-items-center"style={{marginLeft:'160px'}}>
                            <div className="col-lg-6 mb-60">
                                <h4 className="color-black mb-15 wow animate__animated animate__fadeIn"style={{marginBottom:'10px'}}>Luxury Ski Transfers Across the USA - Private & Comfortable Ski Transportation</h4>
                                <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginRight:'100px'}}> Experience premium ski transportation with our luxury ski chauffeur service available at all ski resorts across the USA. Get an instant quote for solo or group travel and enjoy seamless private ski transfers designed for comfort and convenience.</p>
                            ...
                            <div className="col-lg-6 mb-60"><div className="wow animate__animated animate__fadeIn" href="#"><img className="mb-15 wow animate__animated animate__fadeIn" src="/img/ski.png" alt="transp" style={{width:'500px'}}/></div></div>
                        </div>
