...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1>Group Travel Excellence with Travelingoo</h1>
...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/group.png'); /* Background image */
...
<div className="card-container"style={{marginLeft:'150px',marginRight:'180px',marginTop:'10px'}}>
 ...
 <style jsx>
  {`
    ...
    .card-button:hover {
      background-color:rgb(204, 120, 43);
    }
...
<div className="layout-container"style={{marginLeft:'130px',marginRight:'130px',marginTop:'100px'
     ...
     <div className="content-section">
        ...
        <div className="content-row">
          <h2 className="heading">Why Choose Travelingoo for Group Travel:
          </h2>
     ...
     <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Safety as a Priority:
          </h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Flexible and Customized Services:</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    We understand that every group is unique. That's why we offer flexible and customized services to meet your specific requirements. Enjoy a tailored travel experience with Travelingoo.
