...
Stay tuned and get ready to redefine your travel experience with Bookinglane!{activeForm}</p>
    ...
    <h1 style={{marginRight:'200px',color:'white'}}>
    Group Travel Excellence with Bookinglane: Unmatched Luxury and Safety
        </h1>
...
.heroo {
  ...
  background-image: url('/img/group.png'); /* Add your image path here */
...
<div className="layout-container"style={{marginLeft:'150px',marginRight:'150px',marginTop:'100px'
    ...
    Why Choose Bookinglane for Group Travel:
    </h3>
    <p className=" paragraph font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn" >Elevate your group travel experience with Bookinglane, where excellence meets luxury. Whether you're attending high-profile business events, star-studded concerts, or sporting extravaganzas, our premium fleet of SUVs, sedans, and sprinters, coupled with professional chauffeurs, ensures a journey that transcends expectations. </p>
      {/* Section 1 */}
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h1 className="heading">Diverse Fleet Options:</h1>
          <p className=" paragraph font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
          Choose from our fleet of well-maintained SUVs, sedans, and sprinters, providing both style and comfort. No matter the occasion, we have the perfect vehicle for your group.
         </p>
        </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Professional Chauffeurs:</h2>
          <p className="paragraph font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Our chauffeurs are not just drivers; they are your dedicated guides to a seamless journey. With extensive knowledge of the best routes and a commitment to your safety, they ensure a stress-free travel experience.
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Safety as a Priority:</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Your safety is paramount. Bookinglane guarantees secure and private group travel, whether you're heading to a corporate event, a sporting spectacle, or a celebrity-studded affair.
          </p>
        </div>
        <div className="line"></div>
      </div>
      ...
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Corporate and Business Events:</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          Impress clients and elevate your corporate travel experience with Bookinglane. Our group travel services are tailored to the unique demands of business events, ensuring punctuality and professionalism.
         </p>
        </div>
        <div className="line"></div>
      </div>
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Sporting and Entertainment Events:</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          From VIP transportation to major sporting events to exclusive access to concerts and galas, Bookinglane is your partner for luxury group travel. Make a statement as you arrive in style.
          </p>
        </div>
        <div className="line"></div>
      </div>
      <div className="content-section">
        <div className="line"></div>
        <div className="content-row">
          <h2 className="heading">Flexible and Customized Services:</h2>
          <p className="paragraph  font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn ">
          We understand that every group is unique. That's why we offer flexible and customized services to meet your specific requirements. Enjoy a tailored travel experience with Bookinglane.
