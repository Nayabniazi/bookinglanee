...
.hero::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('/img/subcar.png'); /* Background image */
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert" style={{marginLeft:'50px'}}>
                            <div className="col-lg-6">
                                <div className="box-info-aabout-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Discover flawless adventures using Bookinglane's first-rate chauffeur service.</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">
                                    From one-way, round journey, or hourly choices for both business and pleasure passengers. Free cancelable, flexible planning and clear price without hidden fees. Greet and greet with seamless airport to destination transfers. Availability across all of the USA's states. Bookinglane's skilled chauffeur services will help you to improve every trip. 
                                  </p>
                                    
                                </div>
                            </div>
                            <div className="col-lg-6"><img className="wow animate__animated animate__fadeIn" src="/img/drive1.png" alt="transp" /></div>
                        </div>
                        <div className="row align-items-center item-about-2">
                            ...
                            <div className="col-lg-6">
                                <div className="box-info-about-2">
                                    <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Improving Bookinglane Chauffeur Service by means of 24/7 availability and support</h2>
                                    <p className="font-md color-grey-900 mb-20 wow animate__animated animate__fadeIn">

                                    Travelingoo offers premium chauffeur service with round-the-clock availability, ensuring dependability and convenience. You can book a variety of transportation options for family gatherings, corporate conferences, and group transfers with fleet ranges in comfort and design from business sedan to roomy SUVs and VANs.

Guaranteeing a Chauffeur Service
Bookinglane provides private chauffeur services in the United States, including airport pick-ups, special events, one-way, and round-trip options. We ensure a stress-free travel experience by prioritizing dependability, plain pricing, and 24-hour assistance.
                        ...
                        <div className="row align-items-center item-about-2 item-about-2-revert">
                            ...
                            <div className="box-info-aabout-2">
                                     ...
                                     <h2 className="color-black mt-15 mb-25 wow animate__animated animate__fadeIn">Guaranteeing a Chauffeur Service</h2>
                                    ...
                                    Travelingoo provides private chauffeur services in the United States, including airport pick-ups, special events, one-way, and round-trip options. We ensure a stress-free travel experience by prioritizing dependability, plain pricing, and 24-hour assistance.
...
<style jsx>{`
  ...
  <div className="review-slider"style={{marginBottom:'30px',marginTop:'100px'}}>
