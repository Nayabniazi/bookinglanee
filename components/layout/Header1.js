...
export default function Header({ topBarStyle, handleMobileMenuOpen }) {
  ...
  <div className="d-flex align-items-center" href="/">
    ...
    <span className="logo-text" style={{color:'white',fontSize:'20px',marginRight:'60px',}}></span>
  </div>
</div>

                            <div className="header-nav"style={{marginTop:'70px'}}>
                            ...
                            <div className="header-right">
                                ...
                                <div className="d-none d-sm-inline-block"><Link className="btn btn-brand-1 d-none d-xl-inline-block hover-up" href="/loginpage"style={{backgroundColor:'orange',borderRadius:'30px',marginTop:'50px'}}>
